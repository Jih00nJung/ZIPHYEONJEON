...
@Setter
@Entity
@Table(name = "MOLIT_VILLA_SALE_RAW", indexes = {
        @Index(name = "IDX_VS_YM", columnList = "CONTRACT_YM"),
        @Index(name = "IDX_VS_LOC", columnList = "SIGUNGU, ROAD_NAME"),
        @Index(name = "IDX_VS_BUILD", columnList = "BUILDING_NAME, EXCL_AREA"),
        @Index(name = "IDX_VS_REG", columnList = "REG_DATE")
})
public class MolitVillaSaleRawEntity {
    ...
    @Column(name = "LAND_RIGHT_AREA", precision = 12, scale = 6)

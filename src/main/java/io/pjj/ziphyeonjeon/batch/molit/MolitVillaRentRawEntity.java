...
@Setter
@Entity
@Table(name = "MOLIT_VILLA_RENT_RAW", indexes = {
        @Index(name = "IDX_VR_YM", columnList = "CONTRACT_YM"),
        @Index(name = "IDX_VR_LOC", columnList = "SIGUNGU, ROAD_NAME"),
        @Index(name = "IDX_VR_BUILD", columnList = "BUILDING_NAME, EXCL_AREA")
})
public class MolitVillaRentRawEntity {
